          ...
          <Row className="pt-4 text-end">
            <Col md={6} className="pb-2">
              <div className="card shdow p-3" data-aos="fade-up"
                ...
                <h4 className="fw-bold text-primary">Diagnostics  التشخيص</h4>
            ...
            <Col md={6} className="pb-2">
              <div className="card shdow p-3" data-aos="fade-up"
                  data-aos-delay="200"
                  data-aos-duration="1000">
                <h4 className="fw-bold text-primary">Leadership Dashboard  لوحدة إعداد القادة</h4>
            ...
            <Col md={6} className="pb-2">
              <div className="card shdow p-3" data-aos="fade-up"
                ...
                <h4 className="fw-bold text-primary">Recommended Path  المسار (الطريق) الموصي به</h4>
            ...
            <Col md={6} className="pb-2">
              <div className="card shdow p-3" data-aos="fade-up"
                ...
                <h4 className="fw-bold text-primary"> Achievments  الإنجازات</h4>
                <h5 className="opacity-75 pt-2">
            ...
            <Col md={12}>
              <div className="card shdow p-3" data-aos="fade-up"
                  data-aos-delay="100"
                  data-aos-duration="3000">
                <h4 className="fw-bold text-primary"> Teacher Dashboard  لوحة المعلم</h4>
                <h5 className="opacity-75 pt-2">
